 ...
 *
 * This worker connects to Temporal server and executes the plan writer workflows.
 *
 * Usage:
 *   npm run worker
 *   tsx src/worker.ts
...
import * as claudeCliActivities from './activities/claude-cli.activities.js';
...
async function run() {
  ...
  console.log('   Activities: Plan + MCP + Claude CLI activities');
