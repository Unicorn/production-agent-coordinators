...
/**
 * Temporal Workflow Definition (for compiler input)
 */
export interface TemporalWorkflow {
  id: string;
  name: string; // @deprecated - use kebab_name for identifier and display_name for human-friendly name
  kebab_name?: string; // Kebab-case identifier (immutable after creation)
